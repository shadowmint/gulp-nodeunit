...
var _stream_utilsJs = require('./stream_utils.js');

var _stream_utilsJs2 = _interopRequireDefault(_stream_utilsJs);
...
var Plugin = (function () {
  ...
  _createClass(Plugin, [{
    ...
    value: function handle_buffer(file, enc, callback) {
      var content = _stream_utilsJs2['default'].convert_to_string(file.contents, enc);
    ...
    key: 'handle_close',
    value: function handle_close(callback) {
      callback();
    }
